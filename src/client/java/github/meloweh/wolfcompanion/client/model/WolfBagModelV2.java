...
public class WolfBagModelV2 extends Model {
	...
	public static final ResourceLocation STRAP_LAYER_TEXTURE = WolfCompanion.id("textures/entity/wa.png");
	public static final ResourceLocation TEXTURE_LOCATION = WolfCompanion.id("textures/entity/wb.png");
	...
	public static LayerDefinition getTexturedModelData() {
		...
		main.addOrReplaceChild("right", CubeListBuilder.create().texOffs(23, 4).mirror().addBox(-5.0F, 2.0F, -2.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		main.addOrReplaceChild("left", CubeListBuilder.create().texOffs(23, 4).addBox(8.0F, 1.0F, -2.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
