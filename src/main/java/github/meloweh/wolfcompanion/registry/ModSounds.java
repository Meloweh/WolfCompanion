...
public final class ModSounds {
    public static final ResourceLocation WHISTLE_SOUND_ID = WolfCompanion.id("whistle");
    public static final SoundEvent WHISTLE_SOUND_EVENT = SoundEvent.createVariableRangeEvent(WHISTLE_SOUND_ID);

    public static final ResourceLocation LONG_WHISTLE_SOUND_ID = WolfCompanion.id("long_whistle");
