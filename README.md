...
> *v1.0.0+ the whistle now allows you to **despawn** and **respawn** your wolves!*
...
| **Fire/Lava rescue** | As a life saving effort the wolf tries everything to apply a fire resistance potion on you if you find yourself in lava. | ✅ |
| **Healing Potions** | The wolf tries to apply healing potions while the player is in combat with low health. | ✅ |
...
| **Armor Upgrade** | Enabled enchantments like mending and unbreaking for the wolf armor. | ✅ |
| **Food Seeking Behavior** | The wolf may pick up food that is laying around. | ✅ |
...
## Bugs
Feel free to let me know about any suggestions or bugs you might encounter.
